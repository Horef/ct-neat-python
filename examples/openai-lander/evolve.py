...
class LanderGenome(ctneat.DefaultGenome):
...
class PooledErrorCompute(object):
    ...
    def evaluate_genomes(self, genomes, config):
        ...
        for gid, g in genomes:
            nets.append((g, ctneat.nn.FeedForwardNetwork.create(g, config)))
    ...
    while 1:
        try:
            ...
            for g in best_genomes:
                best_networks.append(ctneat.nn.FeedForwardNetwork.create(g, config))
